...
class CafeForm(FlaskForm):
    ...
    coffee = SelectField('Coffee Rating', choices=[('✘'), ('☕'), ('☕️☕️'), ('☕☕☕'), ('☕☕☕☕'), ('☕☕☕☕☕')], validators=[DataRequired()])
...
def add_cafe():
    form = CafeForm()
    data_list = [form.cafe.data, form.location_url.data, form.open_time.data, form.close_time.data,
    form.coffee.data, form.wifi.data, form.power.data]
    if form.validate_on_submit():
        append_list_as_row('cafe-data.csv', data_list)
