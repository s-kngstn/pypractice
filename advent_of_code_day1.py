...
print(list(subset_sum(sorted_list, 2020)))


# # print(sorted_list)
# # print(-2006 * -1)
# Find two numbers from a list that sum 2020
comparison_list = []
target_number = 2020
for num in sorted_list:
    ...
    b = (a * -1)
    # print(b)
    comparison_list.append(b)

combined_list = comparison_list + sorted_list
...
print(duplicate_num)
duplicate_list = list(duplicate_num)
solution = duplicate_list[0] * duplicate_list[1]
print(solution)
print(sum(duplicate_num))
